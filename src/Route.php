 ...
 * @method static TheRoute matchAny(array|string $methods, array|string $paths, callable $handler) Register multiple methods and paths to single handle
